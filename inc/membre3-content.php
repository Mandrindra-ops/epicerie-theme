...
function epicerie_membre3_seed_content() {
    ...
    $post_1 = epicerie_membre3_upsert_post(
        ...
        'Acheter local aide le quartier, garde les produits plus frais et crée une relation plus simple avec les commerçants.',
        array(
            '_yoast_wpseo_title'    => 'Pourquoi acheter local ? - Épicerie du Quartier',
            '_yoast_wpseo_metadesc' => 'Découvrez pourquoi acheter local améliore la fraîcheur des produits et soutient les commerçants du quartier.',
    ...
    $post_2 = epicerie_membre3_upsert_post(
        ...
        'Quelques repères simples pour choisir des fruits et légumes frais selon la saison, l odeur, la couleur et la texture.',
        array(
            '_yoast_wpseo_title'    => 'Comment choisir ses fruits et légumes frais ?',
            '_yoast_wpseo_metadesc' => 'Conseils simples pour reconnaître des fruits et légumes frais, mûrs et adaptés à la saison.',
    ...
    $post_3 = epicerie_membre3_upsert_post(
        ...
        'Du rangement du matin aux derniers clients du soir, voici les petites coulisses d une épicerie de quartier.',
        array(
            '_yoast_wpseo_title'    => 'Une journée chez Épicerie du Quartier',
            '_yoast_wpseo_metadesc' => 'Découvrez les coulisses simples d une journée dans notre épicerie de quartier.',
    ...
    $blog_page = epicerie_membre3_upsert_post(
        ...
        'Articles et conseils de l Épicerie du Quartier.',
        array(
            '_yoast_wpseo_title'    => 'Blog - Conseils et actualités de l épicerie',
            '_yoast_wpseo_metadesc' => 'Retrouvez les articles de l Épicerie du Quartier : achat local, fruits et légumes, coulisses du magasin.',
    ...
    $contact_page = epicerie_membre3_upsert_post(
        ...
        'Adresse, téléphone, carte Google Maps et formulaire de contact de l Épicerie du Quartier.',
        array(
            '_yoast_wpseo_title'    => 'Contact - Épicerie du Quartier à Antananarivo',
            '_yoast_wpseo_metadesc' => 'Contactez l Épicerie du Quartier par formulaire, téléphone, WhatsApp ou en venant directement au magasin.',
    ...
    $reviews_page = epicerie_membre3_upsert_post(
        ...
        'Simulation Google Business Profile, réseaux sociaux et modèles de réponse aux avis clients.',
        array(
            '_yoast_wpseo_title'    => 'Avis clients et e-réputation - Épicerie du Quartier',
            '_yoast_wpseo_metadesc' => 'Avis clients, simulation Google Business Profile et réponses préparées pour gérer l e-réputation.',
...
<section class="epicerie-grid epicerie-blog-links">
    <article>
        ...
        <p>Un article pour expliquer ce que gagne le client, le commerçant et le quartier quand on choisit les produits de proximité.</p>
        <a href="/epicerie/pourquoi-acheter-local/">Lire l article</a>
    </article>
    <article>
        <h2>Comment choisir ses fruits et légumes ?</h2>
        <p>Un guide pratique pour reconnaître les bons produits avec la couleur, l odeur, la saison et quelques habitudes simples.</p>
        <a href="/epicerie/comment-choisir-fruits-legumes/">Lire l article</a>
    </article>
    <article>
        <h2>Une journée chez Épicerie du Quartier</h2>
        <p>Un petit récit des coulisses, depuis l arrivée des produits le matin jusqu aux derniers clients de la journée.</p>
...
<section class="epicerie-section epicerie-reviews">
    ...
    <ul>
        ...
        <li>Description : Petite épicerie de proximité avec produits frais, boissons, produits de base, fruits et légumes de saison.</li>
    </ul>

    <h2>Réseaux sociaux</h2>
    <p>Facebook servira pour annoncer les arrivages et les horaires spéciaux. Instagram servira surtout pour montrer les produits frais et les coulisses. WhatsApp servira pour les petites commandes, les questions rapides et les réservations simples.</p>

    <h2>Modèles de réponse aux avis</h2>
    <h3>Avis positif</h3>
    <p>Merci beaucoup pour votre avis. Nous sommes contents de savoir que vous avez aimé l accueil et les produits. Votre retour nous encourage à garder une épicerie propre, pratique et agréable pour le quartier.</p>

    <h3>Avis mitigé</h3>
    <p>Merci pour votre remarque. Nous sommes désolés si tout n était pas parfait lors de votre passage. Nous allons vérifier le point signalé et faire le nécessaire pour mieux vous accueillir la prochaine fois.</p>

    <h3>Avis négatif</h3>
    <p>Bonjour, merci d avoir pris le temps de nous écrire. Nous sommes désolés pour cette mauvaise expérience. Vous pouvez nous contacter directement au magasin ou par WhatsApp afin que nous comprenions le problème et trouvions une solution correcte.</p>

    <h2>Procédure de veille</h2>
    <p>Chaque semaine, on vérifie le nom de l épicerie sur Google, Facebook et Instagram. Les messages WhatsApp sont consultés chaque jour. Les avis importants sont notés dans un tableau avec la date, le problème, la réponse donnée et l action à faire.</p>
</section>
HTML;
}
